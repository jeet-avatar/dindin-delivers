...
const NetSuiteWolt = () => {
    ...
    const getDashboardCountData =() => {
        setLoading(true)
        Bridge.dashboard.netSuiteWolt.getCount().then((response: any) => {
        ...
        <div className="space-y-6">
            <Spin spinning={loading} tip="Loading...">
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-2xl font-semibold text-neutral-900">{dashboardCount.openPOs}</p>
                    </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-2xl font-semibold text-primary-600">{dashboardCount.pendingApprovalPOs}</p>
                    </div>
            ...
            {chartData && chartData.datasets && (
                <div className="bg-white rounded-lg shadow-card p-6">
                    <h2 className="text-lg font-medium text-neutral-900 mb-4">NetSuite Wolt System Health</h2>
                    <div className="h-80">
