...
def create_sample_data():
    ...
    try:
        ...
        admin_email = os.getenv("SAMPLE_ADMIN_EMAIL", "admin@invoice.com")
        admin_password = os.getenv("SAMPLE_ADMIN_PASSWORD", "admin123")
        ...
        print("   Password: [set via SAMPLE_ADMIN_PASSWORD env var]")
