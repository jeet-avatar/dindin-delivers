...
public struct MenuItem: Identifiable, Codable, Sendable {
    ...
    // Customization options from P2P backend
...
// MARK: - Menu Item Customization Types

/// Customization group for a menu item (e.g., Size, Spice Level, Add-ons)
public struct MenuItemCustomization: Codable, Sendable, Identifiable {
    ...
    public init(name: String, type: CustomizationType, required: Bool, minSelections: Int? = nil, maxSelections: Int? = nil, options: [CustomizationOption]) {
        self.name = name
        self.type = type
...
public struct CustomizationOption: Codable, Sendable, Identifiable {
    public var id: String { name }
    public var name: String
    public var price: Double
    ...
    public init(name: String, price: Double, isDefault: Bool? = nil, isAvailable: Bool? = nil) {
        self.name = name
        self.price = price
...
/// Selected customization for cart/order
public struct SelectedCustomization: Codable, Sendable, Identifiable {
    public var id: String { customizationName }
    public var customizationName: String
    public var selectedOptions: [String]
    public var additionalPrice: Double

    public init(customizationName: String, selectedOptions: [String], additionalPrice: Double) {
