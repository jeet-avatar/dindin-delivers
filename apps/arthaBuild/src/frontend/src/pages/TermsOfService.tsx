      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: 'clamp(40px, 8vw, 80px) clamp(16px, 4vw, 24px)' }}>
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            ArthaBuild is a SuiteScript automation platform developed by {COMPANY_LEGAL}.
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa', marginBottom: '16px' }}>
            Your use of ArthaBuild is governed by your license agreement with {COMPANY_LEGAL} Key license terms:
          </p>
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa', marginBottom: '16px' }}>
            ArthaBuild is offered with a free evaluation tier for individual use, and an enterprise
            tier for teams. Sandbox deployments are unlimited on every tier.
          </p>
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            Entitlements and limits for your account are visible inside the product. For enterprise
            access, contact <a href={`mailto:${SALES_EMAIL}`} style={{ color: '#6366f1' }}>{SALES_EMAIL}</a>.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa', marginBottom: '16px' }}>
            ...
            ArthaBuild based on your prompts belongs to you. {COMPANY_LEGAL} claims no ownership over
            scripts you generate or deploy.
          </p>
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            The ArthaBuild platform, knowledge base, AI models, and proprietary technology remain
            the intellectual property of {COMPANY_LEGAL}
          </p>
        </section>
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            ...
            should be reviewed before deployment to production. {COMPANY_LEGAL} is not responsible for
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            These Terms are governed by the laws applicable to {COMPANY_LEGAL}
        ...
        <section style={{ marginBottom: '48px' }}>
          ...
          <p style={{ lineHeight: 1.8, color: '#a1a1aa' }}>
            For support: <a href={`mailto:${SUPPORT_EMAIL}`} style={{ color: '#6366f1' }}>{SUPPORT_EMAIL}</a><br />
            For sales and licensing: <a href={`mailto:${SALES_EMAIL}`} style={{ color: '#6366f1' }}>{SALES_EMAIL}</a><br />
