...
import { Card, Form, Input, Switch, Button, TimePicker, Select, message, Space } from 'antd';
...
const VendorSettings: React.FC = () => {
  ...
  const fetchSettings = async () => {
    try {
      const response = await axios.get(`https://api.dollor.ai/api/vendors/${vendorId}`);
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.patch(`https://api.dollor.ai/api/vendors/${vendorId}`, updateData);
