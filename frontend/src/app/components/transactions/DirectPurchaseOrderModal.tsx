...
interface DirectPurchaseOrderModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const DirectPurchaseOrderModal: React.FC<DirectPurchaseOrderModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await Bridge.transactions.createDirectPurchaseOrder(formData);
      setSavedTransactionId(response.id);
      onClose();
    } catch (err: any) {
      setError(err.response?.data?.message || 'Failed to create direct purchase order');
    } finally {
      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl w-full max-w-4xl">
          <div className="flex items-center justify-between p-6 border-b border-neutral-200">
            <h2 className="text-xl font-semibold text-neutral-900">New Direct Purchase Order</h2>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="dateSelect" className="block text-sm font-medium text-neutral-700 mb-1">
                    Date *
                  </label>
                  <input
                    type="date"
                ...
                <div>
                  <label htmlFor="approvalStatusSelect" className="block text-sm font-medium text-neutral-700 mb-1">
                    Approval Status *
                  </label>
                  <select
                    required
              ...
              <div>
                <label htmlFor="memoORnotes" className="block text-sm font-medium text-neutral-700 mb-1">
                  Memo / Notes
                </label>
                <textarea
                  rows={3}
                ...
                return (
                  <div key={key} className="border border-neutral-200 rounded-lg p-4 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      ...
                      <div>
                        <label htmlFor="itmeQuantity" className="block text-sm font-medium text-neutral-700 mb-1">
                          Quantity *
                        </label>
                        <input
                          type="number"
...
export default DirectPurchaseOrderModal;