...
**Date**: Tue Feb  3 15:35:44 PST 2026
...
|--------|------------------|--------|
| QA | /Users/jeet/StudioProjects/eatfair-ios/.planning/qa-reports/2026-02-03_15-34-13_pre-deploy/ | ✅ Found |
| UAT | /Users/jeet/StudioProjects/eatfair-ios/.planning/uat-reports/2026-02-03_15-35-20/ | ✅ Found |
...
| `/api/vendors` | ✅ | ✅ | ✅ 200 |
| `/api/vendors/40/menu` | ❌ | ✅ | ✅ 200 |
| `/api/customer/profile` | ✅ | ✅ | ✅ 401 |
| `/api/customer/orders` | ✅ | ✅ | ✅ 401 |
| `/api/addresses` | ✅ | ✅ | ⚠️ 404 |
| `/api/customer/favorites` | ✅ | ✅ | ⚠️ 404 |
| `/api/customers` | ✅ | ✅ | ⚠️ 404 |
| `/api/cart` | ✅ | ✅ | ✅ 401 |
| `/api/promotions` | ✅ | ✅ | ⚠️ 404 |
| `/api/v5/driver` | ✅ | ✅ | ⚠️ 404 |
| `/api/drivers` | ✅ | ✅ | ⚠️ 404 |
| `/api/erp/drivers` | ✅ | ✅ | ✅ 200 |
| `/api/erp/orders` | ✅ | ✅ | ✅ 200 |
| `/api/orders` | ✅ | ✅ | ✅ 200 |
| `/api/vendors/40/menu/categories` | ❌ | ❌ | ✅ 200 |
| `/api/vendors/40/online-status` | ❌ | ❌ | ⚠️ 405 |
...
cat "/Users/jeet/StudioProjects/eatfair-ios/.planning/uat-reports/2026-02-03_15-35-20//UAT_REPORT.md"
```

---

*Generated by Dollor.ai Meta-Validation Agent*
*Report: /Users/jeet/StudioProjects/eatfair-ios/.planning/validation-reports/2026-02-03_15-35-44/META_VALIDATION_REPORT.md*
