...
**Plans:** 4 plans
- [ ] 52-01-PLAN.md — DB migrations: tenants + tenant_features tables, Turion seed, tenant_id column on 105 tables + backfill (Wave 1, parallel with 52-02)
- [ ] 52-02-PLAN.md — Backend signup endpoint POST /api/tenants/signup (atomic Cognito + DB transaction + CUSTOM_AUTH welcome magic-link, IAM grants, Lambda deploy) (Wave 1, parallel with 52-01)
