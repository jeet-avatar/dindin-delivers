...
- [ ] 35-07-PLAN.md — deploy: build-and-push.sh Lambda redeploy + deploy-frontend.sh (F6 pre-flight) + CF invalidation + curl smoke + button audit both repos + Phase 27-34 regression + headless-substitute checkpoint + STATE/ROADMAP update [W6]
