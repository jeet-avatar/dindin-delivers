...
**Date**: Tue Feb  3 20:30:52 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/vendors/published | ✅ PASS | 200 | 306ms |
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 173ms |
| GET /api/promotions/active | ✅ PASS | 200 | 181ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 178ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 411ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 215ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 177ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 160ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 660ms |
...
| GET /api/drivers/{id}/documents | ✅ PASS | 200 | 204ms |
| GET /api/drivers/{id}/status | ✅ PASS | 200 | 228ms |
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 196ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 191ms |
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 165ms |

## 5. Restaurant App Endpoints

| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/orders?vendor_id={id} | ✅ PASS | 200 | 244ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2766ms |
