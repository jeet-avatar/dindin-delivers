...
**Date**: Tue Feb  3 15:24:58 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /health (infrastructure) | ✅ PASS | 200 | 189ms |
| GET /api/vendors | ✅ PASS | 200 | 558ms |
| GET /api/vendors/published | ✅ PASS | 200 | 243ms |
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 189ms |
| GET /api/promotions/active | ✅ PASS | 200 | 172ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 192ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 467ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 242ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 172ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 192ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 565ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/v5/driver/{id}/dashboard | ✅ PASS | 200 | 211ms |
...
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 224ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2485ms |
