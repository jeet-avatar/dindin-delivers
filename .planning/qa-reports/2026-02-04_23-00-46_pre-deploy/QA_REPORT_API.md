...
**Date**: Wed Feb  4 23:00:46 PST 2026
**Phase**: pre-deploy
...
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 166ms |
...
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 600ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/v5/driver/{id}/dashboard | ✅ PASS | 200 | 164ms |
| GET /api/drivers/{id}/documents | ✅ PASS | 200 | 162ms |
| GET /api/drivers/{id}/status | ✅ PASS | 200 | 168ms |
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 175ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 220ms |
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 269ms |

## 5. Restaurant App Endpoints

| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/orders?vendor_id={id} | ✅ PASS | 200 | 373ms |
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 184ms |
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 160ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 260ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 3570ms |
