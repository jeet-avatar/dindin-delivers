...
**Date**: Fri Feb  6 13:32:34 PST 2026
**Phase**: pre-deploy
...
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 516ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 209ms |
| GET /api/customer/orders items field | ✅ PASS | String | P2PCustomerOrder.items: String |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 175ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 194ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 619ms |
