...
**Date**: Tue Feb  3 18:44:32 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|------------|------------|--------|
| order_id | 144 | Integer ✓ | > 0 ✓ | ✅ PASS |
| status | pending_payment | String ✓ | Valid enum ✓ | ✅ PASS |
| total | $13.99 | Double ✓ | >= 0 ✓ | ✅ PASS |
| order_count | 29 | Integer ✓ | - | ✅ PASS |
...
| orders_count | 28 | Integer ✓ | >= 0 ✓ | ✅ PASS |
| menu_items_count | 17 | Integer ✓ | >= 0 ✓ | ✅ PASS |
...
|-------|----------|--------|--------|
| Demo customer has orders | > 0 | 28 | ✅ PASS |
