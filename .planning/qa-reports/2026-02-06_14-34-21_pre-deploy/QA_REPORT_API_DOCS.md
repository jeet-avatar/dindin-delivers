...
| **Total lines** | 12467 | Large file |

ℹ️ **Note**: P2PAPIService.swift has 12467 lines - consider splitting in future refactor
...
| Total routes in main_new.py | ~418 |
| Potential alias routes | ~81 (for backward compatibility) |
