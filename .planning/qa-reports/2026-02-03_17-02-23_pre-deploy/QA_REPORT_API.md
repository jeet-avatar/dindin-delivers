...
**Date**: Tue Feb  3 17:02:23 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/vendors/published | ✅ PASS | 200 | 251ms |
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 180ms |
| GET /api/promotions/active | ✅ PASS | 200 | 166ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 193ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 281ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 198ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 182ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 183ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 550ms |
| GET /api/cart | ✅ PASS | 200 | 170ms |
...
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 188ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 205ms |
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 188ms |

## 5. Restaurant App Endpoints

| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/orders?vendor_id={id} | ✅ PASS | 200 | 231ms |
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 171ms |
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 174ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 239ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2377ms |
