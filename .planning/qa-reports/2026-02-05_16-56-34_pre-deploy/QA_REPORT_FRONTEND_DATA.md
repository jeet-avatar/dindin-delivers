...
**Date**: Thu Feb  5 16:57:26 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|------------|------------|--------|
| order_id | 181 | Integer ✓ | > 0 ✓ | ✅ PASS |
| status | delivered | String ✓ | Valid enum ✓ | ✅ PASS |
| total | $23.788000000000004 | Double ✓ | >= 0 ✓ | ✅ PASS |
| order_count | 50 | Integer ✓ | - | ✅ PASS |
...
| Field | Sample Value | Type Check | Validation | Status |
|-------|--------------|------------|------------|--------|
| vendor_count | 15 | Integer ✓ | > 0 ✓ | ✅ PASS |
...
| Field | Value | Type Check | Validation | Status |
|-------|-------|------------|------------|--------|
| week_earnings | $158.13 | Double ✓ | >= 0 ✓ | ✅ PASS |
| total_deliveries | 16 | Integer ✓ | >= 0 ✓ | ✅ PASS |
...
| orders_count | 57 | Integer ✓ | >= 0 ✓ | ✅ PASS |
| menu_items_count | 17 | Integer ✓ | >= 0 ✓ | ✅ PASS |
...
|-------|----------|--------|--------|
| Demo customer has orders | > 0 | 57 | ✅ PASS |
| Demo restaurant has menu | > 0 | 17 | ✅ PASS |
| System has restaurants | > 0 | 15 | ✅ PASS |
