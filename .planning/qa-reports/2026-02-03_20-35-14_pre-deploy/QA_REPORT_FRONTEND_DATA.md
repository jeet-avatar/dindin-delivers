...
**Date**: Tue Feb  3 20:36:08 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|------------|------------|--------|
| order_id | 145 | Integer ✓ | > 0 ✓ | ✅ PASS |
| status | pending_restaurant | String ✓ | Unknown enum | ⚠️ WARN |
| total | $29.236 | Double ✓ | >= 0 ✓ | ✅ PASS |
| order_count | 30 | Integer ✓ | - | ✅ PASS |
...
| orders_count | 29 | Integer ✓ | >= 0 ✓ | ✅ PASS |
| menu_items_count | 17 | Integer ✓ | >= 0 ✓ | ✅ PASS |
...
|-------|----------|--------|--------|
| Demo customer has orders | > 0 | 29 | ✅ PASS |
