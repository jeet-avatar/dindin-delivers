...
| **Total lines** | 12268 | Large file |

ℹ️ **Note**: P2PAPIService.swift has 12268 lines - consider splitting in future refactor
...
| Total routes in main_new.py | ~415 |
| Potential alias routes | ~79 (for backward compatibility) |
