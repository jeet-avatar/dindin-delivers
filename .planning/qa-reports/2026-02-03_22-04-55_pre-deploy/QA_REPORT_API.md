...
**Date**: Tue Feb  3 22:04:55 PST 2026
**Phase**: pre-deploy
...
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 231ms |
| GET /api/promotions/active | ✅ PASS | 200 | 176ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 193ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 334ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 196ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 172ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 173ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 562ms |
| GET /api/cart | ✅ PASS | 200 | 301ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/orders?vendor_id={id} | ✅ PASS | 200 | 327ms |
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 226ms |
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 170ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 455ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2479ms |
