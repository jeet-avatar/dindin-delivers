...
**Date**: Tue Feb  3 16:26:22 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/vendors | ❌ FAIL | 500 (expected 200) | 197ms |
| GET /api/vendors/published | ✅ PASS | 200 | 263ms |
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 187ms |
| GET /api/promotions/active | ✅ PASS | 200 | 173ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 186ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 298ms |
...
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 572ms |
...
| GET /api/drivers/{id}/status | ✅ PASS | 200 | 179ms |
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 190ms |
...
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 191ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 245ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2440ms |
