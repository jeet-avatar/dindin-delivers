...
| **Total lines** | 12057 | Large file |

⚠️ **WARNING**: P2PAPIService.swift has 12057 lines - endpoints scattered across large file
...
| Total routes in main_new.py | ~451 |
| Potential alias routes | ~51 (for backward compatibility) |

⚠️ Backend has duplicate routes for iOS/Android compatibility
...
**Status**: ⚠️ WARNING - Documentation improvements recommended
