...
**Date**: Thu Feb  5 11:42:59 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|-----------|-------------|--------|
| order_id | 174 | Yes | OrderHistoryView | ✅ PASS |
| id | 174 | Yes | OrderHistoryView | ✅ PASS |
| status | pending_restaurant | Yes | OrderHistoryView | ✅ PASS |
| total | 31.776 | Yes | OrderHistoryView | ✅ PASS |
| subtotal | 13.98 | Yes | OrderHistoryView | ✅ PASS |
| delivery_fee | 12.99 | Yes | OrderHistoryView | ✅ PASS |
| tax | 1.01 | Yes | OrderHistoryView | ✅ PASS |
| tip | 2.7960000000000003 | Yes | OrderHistoryView | ✅ PASS |
| driver_name | __NULL__ | No | OrderHistoryView | ✅ PASS (Optional) |
| driver_id | __NULL__ | No | OrderHistoryView | ✅ PASS (Optional) |
| customer_name | Demo Customer | Yes | OrderHistoryView | ✅ PASS |
| delivery_address | {"street": "12 Teaberry Ln", " | Yes | OrderHistoryView | ✅ PASS |
| restaurant_name | Apple Test Restaurant | Yes | OrderHistoryView | ✅ PASS |
| items | list[2] | Yes | OrderHistoryView | ✅ PASS |
| placed_at | 2026-02-05T19:41:41.755429Z | Yes | OrderHistoryView | ✅ PASS |
| estimated_delivery_time | 2026-02-05T20:11:41.755429Z | Yes | OrderHistoryView | ✅ PASS |
...
|-------|-----------|-----------|-------------|--------|
| week_earnings | 118.38 | Yes | DashboardView | ✅ PASS |
| today_earnings | 39.95 | Yes | DashboardView | ✅ PASS |
| total_deliveries | 11 | Yes | DashboardView | ✅ PASS |
| week_deliveries | 11 | Yes | DashboardView | ✅ PASS |
| rating | 4.9 | Yes | DashboardView | ✅ PASS |
| acceptance_rate | 95.0 | Yes | DashboardView | ✅ PASS |
| completion_rate | 98.0 | Yes | DashboardView | ✅ PASS |
| total_tips | 38.19 | Yes | DashboardView | ✅ PASS |
| online_hours | 5.5 | Yes | DashboardView | ✅ PASS |
