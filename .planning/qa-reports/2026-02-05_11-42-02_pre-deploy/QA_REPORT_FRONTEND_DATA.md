...
**Date**: Thu Feb  5 11:42:52 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|------------|------------|--------|
| order_id | 174 | Integer ✓ | > 0 ✓ | ✅ PASS |
| status | pending_restaurant | String ✓ | Unknown enum | ⚠️ WARN |
| total | $31.776 | Double ✓ | >= 0 ✓ | ✅ PASS |
...
| Field | Value | Type Check | Validation | Status |
|-------|-------|------------|------------|--------|
| week_earnings | $118.38 | Double ✓ | >= 0 ✓ | ✅ PASS |
| total_deliveries | 11 | Integer ✓ | >= 0 ✓ | ✅ PASS |
