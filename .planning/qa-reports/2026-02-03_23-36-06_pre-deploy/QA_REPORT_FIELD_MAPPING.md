...
**Date**: Tue Feb  3 23:37:04 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|-----------|-------------|--------|
| order_id | 145 | Yes | OrderHistoryView | ✅ PASS |
| id | 145 | Yes | OrderHistoryView | ✅ PASS |
| status | ready_for_pickup | Yes | OrderHistoryView | ✅ PASS |
| total | 29.236 | Yes | OrderHistoryView | ✅ PASS |
| subtotal | 11.98 | Yes | OrderHistoryView | ✅ PASS |
| delivery_fee | 12.99 | Yes | OrderHistoryView | ✅ PASS |
| tax | 0.87 | Yes | OrderHistoryView | ✅ PASS |
| tip | 2.3960000000000004 | Yes | OrderHistoryView | ✅ PASS |
...
| delivery_address | {"longitude": -117.603244, "st | Yes | OrderHistoryView | ✅ PASS |
| restaurant_name | Apple Test Restaurant | Yes | OrderHistoryView | ✅ PASS |
| items | [{"menu_item_id": 466, "name": | Yes | OrderHistoryView | ✅ PASS |
| placed_at | 2026-02-04T04:35:53.160299Z | Yes | OrderHistoryView | ✅ PASS |
| estimated_delivery_time | 2026-02-04T05:05:53.160299Z | Yes | OrderHistoryView | ✅ PASS |
