...
**Date**: Tue Feb  3 19:10:15 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/vendors/published | ✅ PASS | 200 | 265ms |
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 178ms |
| GET /api/promotions/active | ✅ PASS | 200 | 165ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 172ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 355ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 229ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 187ms |
...
| GET /api/drivers/{id}/documents | ✅ PASS | 200 | 183ms |
...
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 175ms |

## 5. Restaurant App Endpoints

| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/orders?vendor_id={id} | ✅ PASS | 200 | 280ms |
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 181ms |
