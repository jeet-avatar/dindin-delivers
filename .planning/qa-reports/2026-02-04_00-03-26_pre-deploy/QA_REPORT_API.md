...
**Date**: Wed Feb  4 00:03:26 PST 2026
**Phase**: pre-deploy
...
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 170ms |
| GET /api/promotions/active | ✅ PASS | 200 | 164ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 165ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 376ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 210ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 182ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 178ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 612ms |
...
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 210ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 205ms |
...
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 231ms |
| GET /api/vendors/{id}/documents (auth) | ✅ PASS | 200 | 480ms |
