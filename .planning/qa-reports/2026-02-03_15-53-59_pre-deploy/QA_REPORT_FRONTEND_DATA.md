...
**Date**: Tue Feb  3 15:54:54 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|------------|------------|--------|
| order_id | 142 | Integer ✓ | > 0 ✓ | ✅ PASS |
| status | ready_for_pickup | String ✓ | Valid enum ✓ | ✅ PASS |
| total | $0 | Double ✓ | >= 0 ✓ | ✅ PASS |
| order_count | 27 | Integer ✓ | - | ✅ PASS |
...
| Field | Sample Value | Type Check | Validation | Status |
|-------|--------------|------------|------------|--------|
| vendor_count | 91 | Integer ✓ | > 0 ✓ | ✅ PASS |
...
| Field | Value | Type Check | Validation | Status |
|-------|-------|------------|------------|--------|
| week_earnings | $0 | Double ✓ | >= 0 ✓ | ✅ PASS |
| total_deliveries | 0 | Integer ✓ | >= 0 ✓ | ✅ PASS |
| rating | 0 | Double ✓ | 0-5 ✓ | ✅ PASS |
| acceptance_rate | 0% | Double ✓ | 0-100 ✓ | ✅ PASS |
...
|-------|-------|------------|------------|--------|
| name | (empty) | - | - | ⚠️ WARN |
| email |  | - | Invalid format | ⚠️ WARN |
| is_approved | False | Boolean ✓ | Valid ✓ | ✅ PASS |
...
| orders_count | 26 | Integer ✓ | >= 0 ✓ | ✅ PASS |
| menu_items_count | 17 | Integer ✓ | >= 0 ✓ | ✅ PASS |
...
|-------|----------|--------|--------|
| Demo customer has orders | > 0 | 26 | ✅ PASS |
| Demo restaurant has menu | > 0 | 17 | ✅ PASS |
| System has restaurants | > 0 | 91 | ✅ PASS |
