...
**Date**: Tue Feb  3 19:50:26 PST 2026
**Phase**: pre-deploy
...
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 417ms |
...
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 212ms |
...
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 169ms |
