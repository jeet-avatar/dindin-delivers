...
**iOS Models**:
- `P2PCustomerOrder.items: String` - Customer app expects JSON string
- `P2PVendorOrder.items: [P2PVendorOrderItem]` - Restaurant app expects array

```
✅ /api/customer/orders: items is STRING (P2PCustomerOrder.items: String)
✅ /api/customer/{id}/active-orders: items is STRING
```
...
**Status**: ✅ PASS - API/iOS contracts are compatible
