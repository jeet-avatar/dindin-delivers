...
| **Total lines** | 12276 | Large file |

ℹ️ **Note**: P2PAPIService.swift has 12276 lines - consider splitting in future refactor
...
| Total routes in main_new.py | ~417 |
| Potential alias routes | ~80 (for backward compatibility) |
