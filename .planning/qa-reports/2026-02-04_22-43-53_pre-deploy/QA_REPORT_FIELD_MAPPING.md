...
**Date**: Wed Feb  4 22:44:53 PST 2026
**Phase**: pre-deploy
...
|-------|--------------|-----------|-------------|--------|
| order_id | 173 | Yes | OrderHistoryView | ✅ PASS |
| id | 173 | Yes | OrderHistoryView | ✅ PASS |
| status | delivered | Yes | OrderHistoryView | ✅ PASS |
| total | 31.97 | Yes | OrderHistoryView | ✅ PASS |
| subtotal | 22.97 | Yes | OrderHistoryView | ✅ PASS |
| delivery_fee | 5.99 | Yes | OrderHistoryView | ✅ PASS |
| tax | 2.01 | Yes | OrderHistoryView | ✅ PASS |
| tip | 2.0 | Yes | OrderHistoryView | ✅ PASS |
...
| delivery_address | {"street": "123 Market St", "c | Yes | OrderHistoryView | ✅ PASS |
| restaurant_name | Apple Test Restaurant | Yes | OrderHistoryView | ✅ PASS |
| items | [{"menu_item_id": 1, "name": " | Yes | OrderHistoryView | ✅ PASS |
| placed_at | 2026-02-05T03:24:41.375905Z | Yes | OrderHistoryView | ✅ PASS |
...
|-------|-----------|-----------|-------------|--------|
| week_earnings | 86.42 | Yes | DashboardView | ✅ PASS |
| today_earnings | 7.99 | Yes | DashboardView | ✅ PASS |
| total_deliveries | 7 | Yes | DashboardView | ✅ PASS |
| week_deliveries | 7 | Yes | DashboardView | ✅ PASS |
| rating | 4.9 | Yes | DashboardView | ✅ PASS |
| acceptance_rate | 95.0 | Yes | DashboardView | ✅ PASS |
| completion_rate | 98.0 | Yes | DashboardView | ✅ PASS |
| total_tips | 30.19 | Yes | DashboardView | ✅ PASS |
| online_hours | 3.5 | Yes | DashboardView | ✅ PASS |
