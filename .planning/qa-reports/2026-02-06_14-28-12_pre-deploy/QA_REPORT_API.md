...
**Date**: Fri Feb  6 14:28:14 PST 2026
**Phase**: pre-deploy
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| GET /api/vendors/published | ✅ PASS | 200 | 184ms |
...
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 237ms |
| GET /api/customer/orders items field | ✅ PASS | String | P2PCustomerOrder.items: String |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 166ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 173ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 588ms |
| GET /api/cart | ✅ PASS | 200 | 175ms |
...
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 174ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 216ms |
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 191ms |
...
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 166ms |
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 164ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 307ms |
