...
**Date**: Wed Feb  4 10:54:11 PST 2026
**Phase**: pre-deploy
...
| GET /api/promotions/active | ✅ PASS | 200 | 161ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 171ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 502ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 251ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 168ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 160ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 576ms |
| GET /api/cart | ✅ PASS | 200 | 189ms |
...
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 200ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 276ms |
...
| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 3099ms |
