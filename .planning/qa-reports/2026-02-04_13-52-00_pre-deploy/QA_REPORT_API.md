...
**Date**: Wed Feb  4 13:52:00 PST 2026
**Phase**: pre-deploy
...
| GET /api/vendors/{id}/menu | ✅ PASS | 200 | 193ms |
| GET /api/promotions/active | ✅ PASS | 200 | 229ms |
| GET /api/customer/profile (auth) | ✅ PASS | 200 | 169ms |
| GET /api/customer/orders (auth) | ✅ PASS | 200 | 409ms |
| GET /api/customer/{id}/active-orders | ✅ PASS | 200 | 256ms |
| GET /api/addresses/{userId} | ✅ PASS | 200 | 188ms |
| GET /api/customer/favorites/{id} | ✅ PASS | 200 | 178ms |
| GET /api/customers/{id}/cards | ✅ PASS | 200 | 585ms |
| GET /api/cart | ✅ PASS | 200 | 191ms |
...
| GET /api/erp/drivers/{id}/profile | ✅ PASS | 200 | 182ms |
| GET /api/drivers/{id}/earnings (auth) | ✅ PASS | 200 | 210ms |
| GET /api/erp/orders/available-for-delivery (auth) | ✅ PASS | 200 | 206ms |
...
| GET /api/vendors/{id}/menu/categories | ✅ PASS | 200 | 186ms |
| GET /api/promotions/vendor/{id} | ✅ PASS | 200 | 181ms |
| GET /api/erp/orders/vendor/{id} (auth) | ✅ PASS | 200 | 253ms |
| GET /api/vendors/{id}/documents (auth) | ✅ PASS | 200 | 189ms |

## 6. Demo Setup & Admin

| Endpoint | Status | Code | Response Time |
|----------|--------|------|---------------|
| POST /api/demo/setup | ✅ PASS | 200 | 2497ms |
