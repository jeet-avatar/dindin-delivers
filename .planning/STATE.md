...
| 358 | A/B test arthaBuild BRD generation: Qwen/Ollama vs Claude/Bedrock (non-prod harness). Replayed real intake 2eb5e3be through full pipeline per provider w/ guardrails on both. Result: Claude 143KB/59 sections vs Qwen 50KB/31 sections; "fab_vendor" traps were false positives (ABH/GSTIN/VIP) on both, no real hallucination delta; Claude ~17min vs Qwen ~2min. Code on arthaBuild EC2 (BRD_LLM_PROVIDER switch, default ollama); NO deploy/IAM/GPU change. | 2026-06-19 | 32e2072b | [358-a-b-test-brd-generation-qwen-ollama-vs-c](./quick/358-a-b-test-brd-generation-qwen-ollama-vs-c/) |
## Session Continuity
