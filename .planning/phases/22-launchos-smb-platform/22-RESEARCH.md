...
**What goes wrong:** `apps/zoom/frontend/src/hooks/useWebRTC.ts:7-17` has hardcoded metered.ca TURN server credentials (`TURN_USERNAME_REDACTED` / `TURN_CREDENTIAL_REDACTED`). These are likely the free tier of metered.ca and shared with others.
